...
describe('jest tests for Steve', () => {
    ...
    test('Check valid url for image', () => {
        let test = fns.validateImgUrl('https://condorentalclone.stevecodes.com/#/')
        expect(test).toBe(true)
    })
    test('Check INVALID url for image with spaces and other words', () => {
        let test = fns.validateImgUrl('https://condorentalclone.stevecodes.com/#/ and then there is this')
        expect(test).toBe(false)
    })
    test('Check INVALID double url for image', () => {
        let test = fns.validateImgUrl('https://condorentalclone.stevecodes.com/#/ https://condorentalclone.stevecodes.com/#/')
        expect(test).toBe(false)
    })
